...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>EBENEZER SCHOOL FEES</h1> <!-- For testing purposes, we have added the amount manually. This should proceed from your website -->
    </div>
    <div class="card__container">
        <div class="card">
            <div class="row">
                    <img src="../img/mpesa.png.png" style="width:30%;margin: 0 35%;">
  ...
  <div class="mb-3" hidden>
    ...
    name="year">
            ...
            <div class="row number">
                <div class="info">
                    ...
                    <input id="cardnumber" type="text" name="amount" maxlength="10" placeholder="Ksh."/>
                </div>
            </div>
            <div class="row number">
                <div class="info">
                   <label for="cardnumber">Phone number</label>
                    <input id="cardnumber" type="int" name="phone_number" maxlength="10" placeholder="0700000000"/>
                </div>
        </div>
    </div>
    <div class="button">
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2023 | All Rights Reserved | ShadrackWambua</p>
</div>
   </body>
</html>